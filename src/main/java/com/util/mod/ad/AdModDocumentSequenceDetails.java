...
public class AdModDocumentSequenceDetails implements java.io.Serializable {
   ...
   private String DS_APP_NM;

   public AdModDocumentSequenceDetails () {
   }

   public AdModDocumentSequenceDetails (Integer DS_CODE, String DS_SQNC_NM,
      Date DS_DT_FRM, Date DS_DT_TO, char DS_NMBRNG_TYP,
      String DS_INTL_VL, String DS_APP_NM) {
   ...
   public String toString() {
      ...
      + DS_INTL_VL + " DS_APP_NM = " + DS_APP_NM;
   }

} // AdModDocumentSequenceDetails class   