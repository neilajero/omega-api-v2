...
import com.util.ad.AdBranchArTaxCodeDetails;

public class AdModBranchArTaxCodeDetails extends AdBranchArTaxCodeDetails implements java.io.Serializable{
	...
	private String BTC_INTRM_CD_ACCNT_NMBR; 
	private String BTC_COA_GL_INTRM_CD_DESC; 


	public AdModBranchArTaxCodeDetails() {
    }
	...
	public String getBtcTaxCodeAccountNumber() {
	   ...
	   public void setBtcTaxCodeAccountDescription(String BTC_COA_GL_TX_CD_DESC) {
		...
		public String getBtcInterimCodeAccountNumber() {
		   	
		   	   return BTC_INTRM_CD_ACCNT_NMBR;
		   	
		   }
		   
		   public void setBtcInterimCodeAccountNumber(String BTC_INTRM_CD_ACCNT_NMBR) {
		   	
		   	   this.BTC_INTRM_CD_ACCNT_NMBR = BTC_INTRM_CD_ACCNT_NMBR;
		   	
		   }

		   public String getBtcInterimCodeAccountDescription() {
		   	
		   	   return BTC_COA_GL_INTRM_CD_DESC;
		   	
		   }
		   
		   public void setBtcInterimCodeAccountDescription(String BTC_COA_GL_INTRM_CD_DESC) {
		   	
		   	   this.BTC_COA_GL_INTRM_CD_DESC = BTC_COA_GL_INTRM_CD_DESC;
