...
public class InvRepBranchStockTransferInPrintDetails implements java.io.Serializable {
    
    private Date BSTP_BST_DT; 
    private String BSTP_BST_TYP;
    private String BSTP_BST_NMBR; 
    private String BSTP_BST_TRNSFR_OUT_NMBR;
    ...
    public InvRepBranchStockTransferInPrintDetails() {
    }
    ...
    public String getBstpBstTransferOutNumber() {
        
        return BSTP_BST_TRNSFR_OUT_NMBR;
        
    }
    
    public void setBstpBstTransferOutNumber(String BSTP_BST_TRNSFR_OUT_NMBR) {
        
        this.BSTP_BST_TRNSFR_OUT_NMBR = BSTP_BST_TRNSFR_OUT_NMBR;
    ...
    public String getBstpBslItemLocation() {
        
        return BSTP_BSL_ITM_LCTN;
        
    }
    
    public void setBstpBslItemLocation(String BSTP_BSL_ITM_LCTN) {
        
        this.BSTP_BSL_ITM_LCTN = BSTP_BSL_ITM_LCTN;
    ...
    public double getBstpBslQuantityReceived() {
        
        return BSTP_BSL_QTY_RCVD;
        
    }
    
    public void setBstpBslQuantityReceived(double BSTP_BSL_QTY_RCVD) {
        
        this.BSTP_BSL_QTY_RCVD = BSTP_BSL_QTY_RCVD;
