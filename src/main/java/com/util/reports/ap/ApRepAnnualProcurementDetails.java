...
public class ApRepAnnualProcurementDetails implements java.io.Serializable{
	...
	public ApRepAnnualProcurementDetails() {
    }
	...
	public void setApDepartment(String AP_DPRTMNT) {
		
		this.AP_DPRTMNT = AP_DPRTMNT;
