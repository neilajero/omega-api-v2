...
public class GlRepMonthlyVatDeclarationDetails implements java.io.Serializable {
   ...
   public GlRepMonthlyVatDeclarationDetails() {
   }
   
   public GlRepMonthlyVatDeclarationDetails(double GRSS_SLS_RCPT, 
       double TX_DUE, double ON_TXBL_GDS, double OUTPUT_TX, double INPUT_TX, double SLS_AMNT, double RVNE,double SLS_AMNT_EXMPT , double SLS_AMNT_ZR_RTD , double TTL_SLS_EXMPT_ZR, double REV_AMNT_EXMPT, double REV_AMNT_ZR_RTD, double TTL_REV_EXMPT_ZR) {
