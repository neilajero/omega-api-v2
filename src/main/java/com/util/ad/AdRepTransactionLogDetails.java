...
public class AdRepTransactionLogDetails implements java.io.Serializable, Comparable {
   ...
   private byte txlVoid;
   
   public AdRepTransactionLogDetails() {
   }
	...
	public byte getTxlVoid() {
		
		return txlVoid;
		
	}
	
	public void setTxlVoid(byte txlVoid) {
		
		this.txlVoid = txlVoid;
		
	}
	
	public int compareTo(Object o) {
		
		AdRepTransactionLogDetails details =(AdRepTransactionLogDetails)o;
...
} // AdRepTransactionLogDetails class   