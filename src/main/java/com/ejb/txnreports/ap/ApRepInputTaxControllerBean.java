...
import com.util.reports.ap.ApRepInputTaxDetails;
import com.util.Debug;
import com.util.EJBCommon;
import com.util.EJBContextClass;
import com.util.EJBHomeFactory;

@Stateless(name = "ApRepInputTaxControllerEJB")
public class ApRepInputTaxControllerBean extends EJBContextClass implements ApRepInputTaxController {
    ...
    public ArrayList executeApRepInputTax(HashMap criteria, ArrayList adBrnchList, Integer AD_CMPNY) throws GlobalNoRecordFoundException {

        Debug.print("ApRepInputTaxControllerBean executeApRepInputTax");
        ...
        try {
            ...
            for (Object taxInterface : glTaxInterfaces) {
                ...
                for (Object taxInterfaceTc : glTaxInterfaceTcs) {
                    ...
                    if (glTaxInterfaceTc.getTiDocumentType().equals("GL JOURNAL")) {
                        ...
                        if (glJournal.getJlDebit() == EJBCommon.TRUE) {
                            ...
                            INPUT_TAX += EJBCommon.roundIt(glJournal.getJlAmount(), PRECISION_UNIT);
                        ...
                        LocalApDistributionRecord apDistributionRecord = apDistributionRecordHome.findByPrimaryKey(glTaxInterfaceTc.getTiTxlCode());

                        if (apDistributionRecord.getDrDebit() == EJBCommon.TRUE) {

                            INPUT_TAX += EJBCommon.roundIt(apDistributionRecord.getDrAmount(), PRECISION_UNIT);
                            NET_AMOUNT += EJBCommon.roundIt(glTaxInterfaceTc.getTiNetAmount(), PRECISION_UNIT);
                ...
                ApRepInputTaxDetails details = new ApRepInputTaxDetails();
                details.setTiTinOfVendor(glTaxInterface.getTiSlTin());
                details.setTiRegisteredName(glTaxInterface.getTiSlName());
                details.setTiLastName(null);
                details.setTiFirstName(null);
                details.setTiMiddleName(null);
                details.setTiAddress1(glTaxInterface.getTiSlAddress());
                details.setTiAddress2(null);
                details.setTiNetAmount(NET_AMOUNT);
                details.setTiInputTax(INPUT_TAX);
    ...
    public AdCompanyDetails getAdCompany(Integer AD_CMPNY) {
        ...
        Debug.print("ApRepInputTaxControllerBean getAdCompany");
    ...
    public void ejbCreate() throws CreateException {
        ...
        Debug.print("ApRepInputTaxControllerBean ejbCreate");
    }
}