...
@Stateless(name = "GlJournalBatchPrintControllerEJB")
public class GlJournalBatchPrintControllerBean extends EJBContextClass implements GlJournalBatchPrintController {
